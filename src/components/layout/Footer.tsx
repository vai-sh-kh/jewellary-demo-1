        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-8 lg:gap-10">
            <div>
              <Link
                href="/"
                className="flex items-center gap-2 md:gap-3 text-white group mb-4 md:mb-0"
              >
                ...
                <span className="text-base md:text-lg font-serif font-medium tracking-widest uppercase">
                  Luxe Jewels
                </span>
              </Link>
            </div>
      ...
      <footer className="bg-[#14100c] border-t border-[#26201a] pt-12 md:pt-16 lg:pt-20 pb-6 md:pb-8 lg:pb-10 px-4 md:px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 mb-12 md:mb-16 lg:mb-20">
          <div className="lg:col-span-1">
            <h3 className="text-white text-xl md:text-2xl font-bold font-serif mb-4 md:mb-6 tracking-wide">
              LUMIÈRE
            </h3>
            <p className="text-text-secondary text-sm leading-relaxed mb-6 md:mb-8 opacity-80">
              Timeless elegance handcrafted for the modern connoisseur.
              Established in Paris, celebrated worldwide.
            </p>
          ...
          <div>
            <h4 className="text-white text-[10px] md:text-xs font-bold uppercase tracking-widest mb-4 md:mb-6 lg:mb-8">
              Boutiques
            </h4>
            <ul className="space-y-3 md:space-y-4">
              <li>
                <Link
                  href="#"
                  className="text-text-secondary hover:text-primary transition-colors text-xs md:text-sm font-light min-h-[44px] flex items-center"
                >
                  Paris, Place Vendôme
                </Link>
              </li>
          ...
          <div>
            ...
            <p className="text-text-secondary text-xs mb-4 md:mb-6 opacity-80">
              Be the first to receive invitations to private viewings.
            </p>
        ...
        <div className="max-w-7xl mx-auto border-t border-[#26201a] pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
          <p className="text-white/30 text-[9px] md:text-[10px] uppercase tracking-wider">
            © 2024 Lumière Jewelry. All rights reserved.
          </p>
          <div className="flex flex-wrap gap-4 md:gap-6 lg:gap-8">
            <Link
              href="#"
              className="text-white/30 hover:text-white text-[9px] md:text-[10px] uppercase tracking-wider transition-colors min-h-[44px] flex items-center"
            >
              Privacy
            </Link>
            <Link
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 lg:gap-12 mb-12 md:mb-16 lg:mb-20 border-b border-white/5 pb-8 md:pb-12 lg:pb-16">
          <div className="lg:col-span-5 flex flex-col gap-4 md:gap-6 pr-0 lg:pr-12">
            <h3 className="text-white font-serif italic text-2xl md:text-3xl">
              Join Our World
            </h3>
          ...
          {footerSections.slice(0, 3).map((section) => (
            <div key={section.title} className="lg:col-span-2 sm:col-span-4">
              <h5 className="text-white text-[10px] md:text-xs font-bold uppercase tracking-widest mb-4 md:mb-6 text-primary">
                {section.title}
              </h5>
              <ul className="flex flex-col gap-3 md:gap-4">
                {section.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-white/60 hover:text-white text-xs md:text-sm transition-colors min-h-[44px] flex items-center"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 lg:gap-8">
            <Link
              href="#"
              className="text-white/40 hover:text-white text-[10px] md:text-xs uppercase tracking-wider min-h-[44px] flex items-center"
            >
              Privacy Policy
            </Link>
            <Link
